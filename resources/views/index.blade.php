...
@section("content")
    <main id="main" class="w-full h-auto sm:h-[607px] bg-no-repeat bg-cover pt-20">
        <div class="container flex justify-center mx-auto h-full sm:flex-row flex-col-reverse sm:pt-0 pt-24">
            <div class="sm:basis-1/2 basis-full flex justify-center sm:items-start items-center flex-col">
                <h1 class="font-[morabba] font-bold text-[50px] lg:text-[60px] dark:text-white">{{ setting("name") }}</h1>
                <p class="lg:text-[17px] text-[15px] mt-8 dark:text-white">{{ setting("job") }}</p>
                <div class="flex justify-start items-center gap-3 mt-8">
                    {{--Resume Download--}}
                    <a href="{{ setting("resume") }}"
                       class="bg-green-500 w-36 sm:w-40 flex justify-center items-center p-3 rounded-full hover:shadow-green-500 hover:shadow-big text-white"
                    ...
                    <a href="{{ setting("email") }}" target="_blank"
                       class="bg-gray-500 hover:bg-green-500 group rounded-full relative hover:shadow-green-500 hover:shadow-big">
                        <div class="bg-white rounded-full m-2.5 sm:w-8 w-7">
                    ...
                    <a href="{{ setting("github") }}" target="_blank"
                       class="bg-gray-500 hover:bg-black rounded-full p-1 relative group hover:shadow-black hover:shadow-big">
                        <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-11 w-10 fill-white" viewBox="0 0 72 72">
                            <path
                    ...
                    <a href="{{ setting("telegram") }}" target="_blank"
                       class="bg-gray-500 hover:bg-sky-600 rounded-full p-1 relative group hover:shadow-sky-600 hover:shadow-big">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" class="sm:w-11 w-10 fill-white">
                            <path
                    ...
                    <a href="{{ setting("instagram") }}" target="_blank"
                       class="bg-gray-500 hover:bg-rose-600 rounded-full p-2 relative group hover:shadow-rose-600 hover:shadow-big">
                        <svg xmlns="http://www.w3.org/2000/svg" class="sm:w-9 w-8 fill-white" viewBox="0 0 64 64">
                            <path
    ...
    <section id="about_us">
        <div class="container mx-auto pt-16 max-w-[95%]">
            <h1 class="font-[morabba] font-bold text-[40px] text-[#1F2937] before:inline-block relative before:absolute before:bottom-[-5px] before:w-[50%] before:h-[4px] before:bg-green-500 w-fit dark:text-white">
                درباره من</h1>
            <div
                class="w-full bg-white dark:bg-[#3F3F46] dark:text-white rounded-[20px] sm:text-lg text-[16px] p-9 mt-10 leading-9 shadow-lg">{!! setting("about") !!}</div>
        </div>
    </section>
