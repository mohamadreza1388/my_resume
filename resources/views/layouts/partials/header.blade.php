<header class="header fixed top-[25px] right-1/2 transform translate-x-1/2 w-[calc(100%-6rem)] backdrop-blur border border-neutral-200/50 bg-gray-400/60 h-[90px] rounded-[20px] flex px-10">
