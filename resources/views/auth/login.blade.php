    ...
    <main class="d-flex justify-content-center pb-5">
        <div class="container row d-flex justify-content-center">
            <div class="col-md-7 col-sm-10 col-12">
                <div class="login w-100 rounded-4 shadow p-3 py-4">
                    <div class="wrapper mb-3 d-flex justify-content-center gap-3 mx-auto">
                        <a href="{{ route("login") }}" class="fw-semibold rounded-3 d-flex justify-content-center align-items-center gap-2 active">
                            ورود
                        ...
                        <a href="{{ route("register") }}" class="fw-semibold rounded-3 d-flex justify-content-center align-items-center gap-2">
                            ثبت نام
                    ...
                    <form action="{{ route('login') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="mb-4">
                            <label for="user-email" class="form-label text-light">
                                ادرس ایمیل
                        ...
                        <div class="mb-4">
                            <label for="user-password" class="form-label text-light">
                                رمز عبور
                                <span class="red fw-semibold">*</span>
                            </label>
                        ...
                        <div class="mb-4 d-flex justify-content-start align-items-center gap-4">
                            <button type="submit" class="border-0 bg1 rounded-3 text-white py-2 px-4">ورود</button>
                        ...
                        <div class="mb-0">
                            @if (Route::has('password.request'))
                                <a class="color1 forgot-pas" href="{{ route('password.request') }}">گذر واژه خود را
                                    فراموش کرده اید؟</a>
                            @endif
                        </div>
                    </form>
