    ...
    <main class="tab shadow p-3 overflow-auto d-block">
        <div class="container row d-flex justify-content-center">
            <div class="col-md-7 col-sm-10 col-12">
                <form method="post" action="{{ route("work_sample-post-create") }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input id="subTitle" type="text" class="py-2 form-control @error('subTitle') is-invalid @enderror"
                               name="subTitle" required autocomplete="subTitle" autofocus>
                        @error('subTitle')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-0">
                        <button type="submit" class="border-0 bg1 rounded-3 text-white py-2 px-4">ایجاد نمونه کار</button>
                    </div>
