    ...
    <main class="tab shadow p-3 overflow-auto d-block">
        <div class="container row d-flex justify-content-center">
            <div class="col-md-7 col-sm-10 col-12">
                <form method="post" action="{{ route("way_communication-post-edit",$wayCommunication->id) }}">
                    @csrf
                    @method("put")
                    ...
                    <div class="mb-4">
                        ...
                        <input id="imgSrc" type="text" class="py-2 form-control @error('imgSrc') is-invalid @enderror"
                               name="imgSrc" required autocomplete="imgSrc" autofocus value="{{ $wayCommunication->img_src }}">
                        @error('imgSrc')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="title" type="text" class="py-2 form-control @error('title') is-invalid @enderror"
                               name="title" required autocomplete="title" autofocus value="{{ $wayCommunication->title }}">
                        @error('title')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="platformName" type="text" class="py-2 form-control @error('platformName') is-invalid @enderror"
                               name="platformName" required autocomplete="platformName" autofocus value="{{ $wayCommunication->platform_name }}">
                        @error('platformName')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="link" id="link"
                            ...
                            @foreach($links as $link)
                                <option value="{{ $link->id }}" @if($wayCommunication->link_id == $link->id) selected @endif>{{ $link->link }} : {{ $link->title }}</option>
                            @endforeach
                        </select>
                        @error('link')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="tooltip" type="text" class="py-2 form-control @error('tooltip') is-invalid @enderror"
                               name="tooltip" autocomplete="tooltip" autofocus value="{{ $wayCommunication->tooltip }}">
                        @error('tooltip')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="fontIcon" type="text" class="py-2 form-control @error('fontIcon') is-invalid @enderror"
                               name="fontIcon" autocomplete="fontIcon" autofocus value="{{ $wayCommunication->font_icon_class }}">
                        @error('fontIcon')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="at" type="text" class="py-2 form-control @error('at') is-invalid @enderror"
                               name="at" autocomplete="at" autofocus value="{{ $wayCommunication->at }}">
                        @error('at')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
